...
public class CreateAccount extends BaseTest{
	...
	{
		logger.info("Running createView");
		openAccoutPage();
	...
	{
		logger.info("Running mergeAccounts");
		openAccoutPage();
		createAccount();
		openAccoutPage();
	...
	{
		logger.info("Running createAccountReport");
		openAccoutPage();
